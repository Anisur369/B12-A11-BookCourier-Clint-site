    ...
    >
      <div className="whitebg shadow-md hover:shadow-xl hover:scale-105 transition-transform duration-300 flex flex-col rounded-2xl overflow-hidden">
        ...
        <div className="p-4 flex flex-col gap-2">
          ...
          <p className="description text-sm line-clamp-2">
            {book.description || "No review available."}
          </p>
          ...
          <div className="flex justify-between items-center mt-4">
            <span
              className={`px-2 py-1 rounded-full text-xs font-medium ${book.status === "publish" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
            >
