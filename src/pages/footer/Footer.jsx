    ...
    <div>
        ...
        <nav>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4 text-xl mt-4">
              ...
              <a
                href="https://x.com/anisurrahmanARS2"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/anisurrahmanARS2/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/AnisurRahman-ARS2/"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <div className="w-full mt-0 whitebg">
        ...
        <p className="text-center text-sm p-2 text-secondary">
          ...
          <Link
            to="https://anisur-rahman.netlify.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
