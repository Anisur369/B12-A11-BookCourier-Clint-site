  ...
  const steps = [
    {
      ...
      description:
        "Sign up for free to access BookCourier services and connect with nearby libraries.",
    },
    {
      icon: <FaBook className="text-4xl text-green-500 mb-4" />,
      title: "Request a Book",
      description:
        "Choose a book from partnered libraries and submit a pickup or delivery request easily.",
    },
    {
      icon: <FaSearch className="text-4xl text-green-500 mb-4" />,
      title: "Track Your Request",
      description:
        "Monitor your book’s status—from approval to dispatch—directly from your dashboard.",
    },
    {
      icon: <FaCheckCircle className="text-4xl text-green-500 mb-4" />,
      title: "Receive or Return Books",
      description:
        "Get books delivered to your home or schedule a pickup for returning them with ease.",
    },
  ];
