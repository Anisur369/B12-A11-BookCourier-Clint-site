...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      name: "John D.",
      feedback:
        "The home delivery feature is a total game changer for readers.",
  ...
  return (
    <section ref={sectionRef} className="py-20 graybg" id="testimonials">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="description italic mb-3">“{t.feedback}”</p>
