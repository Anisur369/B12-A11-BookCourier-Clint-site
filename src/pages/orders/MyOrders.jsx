...
const MyOrders = () => {
  ...
  if (!orders.length)
    return (
      <p className="text-center mt-10 text-gray-700">You have no orders.</p>
    );
            ...
            {orders.map((order, index) => (
              ...
              >
                ...
                <td className="px-4 py-2 font-medium">
                  {order.bookDetails?.bookName || "N/A"}
                </td>
                <td className="px-4 py-2 text-green-600 font-medium">
                  ${order.bookDetails?.price?.toFixed(2) || "0.00"}
                </td>
